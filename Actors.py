...
class TriGraphHoldTimeActor(pykka.ThreadingActor):
    ...
    def on_failure(self, exception_type, exception_value, traceback):
        ...
        self.dnaref.tell({"title":"KS Collector TGHT Error!","text":"{}:{}".format(exception_type,exception_value)})
        with open("err.log",'a') as f:
            f.writelines(["Failure! {}:{}:{}".format(exception_type,exception_value,traceback)])
